...
class Subtitle(BaseStructure):
    def __init__(self, name, time=None, size=35, pos=(Config.WIDTH // 2, Config.HEIGHT // 2), color='white',
                 callback=None):
...
def get_typed_subtitles(_text, _time=0.2, _time_diff=0.05, pos=None, callback=None):
    if pos is None:
